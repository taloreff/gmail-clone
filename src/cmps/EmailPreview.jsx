...
export function EmailPreview({ email, onRemoveEmail, onUpdateEmail }) {
    ...
    const shortSubject = email.subject.length > 20 ? email.subject.substring(0, 20) + '...' : email.subject;
    const shortBody = email.body.length > 200 ? email.body.substring(0, 200) + '...' : email.body;
